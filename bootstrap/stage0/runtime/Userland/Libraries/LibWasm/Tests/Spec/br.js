...
describe("br_0", () => {
    ...
    let content, module;
    try {
        content = readBinaryWasmFile("Fixtures/SpecTests/br_0.wasm");
    ...
    _test("execution of br_0: type-i32 (instance 0)", () => {
        let _type_i32 = module.getExport("type-i32");
        expect(_type_i32).not.toBeUndefined();
        let _type_i32_result = module.invoke(_type_i32);
    });

    _test("execution of br_0: type-i64 (instance 0)", () => {
        let _type_i64 = module.getExport("type-i64");
        expect(_type_i64).not.toBeUndefined();
        let _type_i64_result = module.invoke(_type_i64);
    });

    _test("execution of br_0: type-f32 (instance 0)", () => {
        let _type_f32 = module.getExport("type-f32");
        expect(_type_f32).not.toBeUndefined();
        let _type_f32_result = module.invoke(_type_f32);
    });

    _test("execution of br_0: type-f64 (instance 0)", () => {
        let _type_f64 = module.getExport("type-f64");
        expect(_type_f64).not.toBeUndefined();
        let _type_f64_result = module.invoke(_type_f64);
    });

    _test("execution of br_0: type-i32-i32 (instance 0)", () => {
        let _type_i32_i32 = module.getExport("type-i32-i32");
        expect(_type_i32_i32).not.toBeUndefined();
        let _type_i32_i32_result = module.invoke(_type_i32_i32);
    });

    _test("execution of br_0: type-i64-i64 (instance 0)", () => {
        let _type_i64_i64 = module.getExport("type-i64-i64");
        expect(_type_i64_i64).not.toBeUndefined();
        let _type_i64_i64_result = module.invoke(_type_i64_i64);
    });

    _test("execution of br_0: type-f32-f32 (instance 0)", () => {
        let _type_f32_f32 = module.getExport("type-f32-f32");
        expect(_type_f32_f32).not.toBeUndefined();
        let _type_f32_f32_result = module.invoke(_type_f32_f32);
    });

    _test("execution of br_0: type-f64-f64 (instance 0)", () => {
        let _type_f64_f64 = module.getExport("type-f64-f64");
        expect(_type_f64_f64).not.toBeUndefined();
        let _type_f64_f64_result = module.invoke(_type_f64_f64);
    });

    _test("execution of br_0: type-i32-value (instance 0)", () => {
    ...
    _test("execution of br_0: type-i64-value (instance 0)", () => {
    ...
    _test("execution of br_0: type-f32-value (instance 0)", () => {
    ...
    _test("execution of br_0: type-f64-value (instance 0)", () => {
    ...
    /* Unknown command assert_return */ _test.skip(
        "execution of br_0: <unknown> (instance 0)",
        () => {
    ...
    _test("execution of br_0: as-block-first (instance 0)", () => {
    ...
    _test("execution of br_0: as-block-mid (instance 0)", () => {
    ...
    _test("execution of br_0: as-block-last (instance 0)", () => {
    ...
    _test("execution of br_0: as-block-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-loop-first (instance 0)", () => {
    ...
    _test("execution of br_0: as-loop-mid (instance 0)", () => {
    ...
    _test("execution of br_0: as-loop-last (instance 0)", () => {
    ...
    _test("execution of br_0: as-br-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-br_if-cond (instance 0)", () => {
    ...
    _test("execution of br_0: as-br_if-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-br_if-value-cond (instance 0)", () => {
    ...
    _test("execution of br_0: as-br_table-index (instance 0)", () => {
    ...
    _test("execution of br_0: as-br_table-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-br_table-value-index (instance 0)", () => {
    ...
    _test("execution of br_0: as-return-value (instance 0)", () => {
    ...
    /* Unknown command assert_return */ _test.skip(
        "execution of br_0: <unknown> (instance 1)",
        () => {
            let __unknown_ = module.getExport("<unknown>");
            expect(__unknown_).not.toBeUndefined();
        }
    ...
    _test("execution of br_0: as-if-cond (instance 0)", () => {
    ...
    _test("execution of br_0: as-if-then (instance 0)", () => {
    ...
    _test("execution of br_0: as-if-then (instance 1)", () => {
        let _as_if_then = module.getExport("as-if-then");
        expect(_as_if_then).not.toBeUndefined();
    ...
    _test("execution of br_0: as-if-else (instance 0)", () => {
    ...
    _test("execution of br_0: as-if-else (instance 1)", () => {
        let _as_if_else = module.getExport("as-if-else");
        expect(_as_if_else).not.toBeUndefined();
    ...
    _test("execution of br_0: as-select-first (instance 0)", () => {
    ...
    _test("execution of br_0: as-select-first (instance 1)", () => {
        let _as_select_first = module.getExport("as-select-first");
        expect(_as_select_first).not.toBeUndefined();
    ...
    _test("execution of br_0: as-select-second (instance 0)", () => {
    ...
    _test("execution of br_0: as-select-second (instance 1)", () => {
        let _as_select_second = module.getExport("as-select-second");
        expect(_as_select_second).not.toBeUndefined();
    ...
    _test("execution of br_0: as-select-cond (instance 0)", () => {
    ...
    _test("execution of br_0: as-select-all (instance 0)", () => {
        let _as_select_all = module.getExport("as-select-all");
        expect(_as_select_all).not.toBeUndefined();
        let _as_select_all_result = module.invoke(_as_select_all);
        expect(_as_select_all_result).toBe(8);
    });

    _test("execution of br_0: as-call-first (instance 0)", () => {
    ...
    _test("execution of br_0: as-call-mid (instance 0)", () => {
    ...
    _test("execution of br_0: as-call-last (instance 0)", () => {
    ...
    _test("execution of br_0: as-call-all (instance 0)", () => {
        let _as_call_all = module.getExport("as-call-all");
        expect(_as_call_all).not.toBeUndefined();
        let _as_call_all_result = module.invoke(_as_call_all);
        expect(_as_call_all_result).toBe(15);
    });

    _test("execution of br_0: as-call_indirect-func (instance 0)", () => {
    ...
    _test("execution of br_0: as-call_indirect-first (instance 0)", () => {
    ...
    _test("execution of br_0: as-call_indirect-mid (instance 0)", () => {
    ...
    _test("execution of br_0: as-call_indirect-last (instance 0)", () => {
    ...
    _test("execution of br_0: as-call_indirect-all (instance 0)", () => {
        let _as_call_indirect_all = module.getExport("as-call_indirect-all");
        expect(_as_call_indirect_all).not.toBeUndefined();
        let _as_call_indirect_all_result = module.invoke(_as_call_indirect_all);
        expect(_as_call_indirect_all_result).toBe(24);
    });

    _test("execution of br_0: as-local.set-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-local.tee-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-global.set-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-load-address (instance 0)", () => {
    ...
    _test("execution of br_0: as-loadN-address (instance 0)", () => {
    ...
    _test("execution of br_0: as-store-address (instance 0)", () => {
    ...
    _test("execution of br_0: as-store-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-store-both (instance 0)", () => {
        let _as_store_both = module.getExport("as-store-both");
        expect(_as_store_both).not.toBeUndefined();
        let _as_store_both_result = module.invoke(_as_store_both);
        expect(_as_store_both_result).toBe(32);
    });

    _test("execution of br_0: as-storeN-address (instance 0)", () => {
    ...
    _test("execution of br_0: as-storeN-value (instance 0)", () => {
    ...
    _test("execution of br_0: as-storeN-both (instance 0)", () => {
        let _as_storeN_both = module.getExport("as-storeN-both");
        expect(_as_storeN_both).not.toBeUndefined();
        let _as_storeN_both_result = module.invoke(_as_storeN_both);
        expect(_as_storeN_both_result).toBe(34);
    });

    _test("execution of br_0: as-unary-operand (instance 0)", () => {
    ...
    _test("execution of br_0: as-binary-left (instance 0)", () => {
    ...
    _test("execution of br_0: as-binary-right (instance 0)", () => {
    ...
    _test("execution of br_0: as-binary-both (instance 0)", () => {
        let _as_binary_both = module.getExport("as-binary-both");
        expect(_as_binary_both).not.toBeUndefined();
        let _as_binary_both_result = module.invoke(_as_binary_both);
        expect(_as_binary_both_result).toBe(46);
    });

    _test("execution of br_0: as-test-operand (instance 0)", () => {
    ...
    _test("execution of br_0: as-compare-left (instance 0)", () => {
    ...
    _test("execution of br_0: as-compare-right (instance 0)", () => {
    ...
    _test("execution of br_0: as-compare-both (instance 0)", () => {
        let _as_compare_both = module.getExport("as-compare-both");
        expect(_as_compare_both).not.toBeUndefined();
        let _as_compare_both_result = module.invoke(_as_compare_both);
        expect(_as_compare_both_result).toBe(44);
    });

    _test("execution of br_0: as-convert-operand (instance 0)", () => {
    ...
    _test("execution of br_0: as-memory.grow-size (instance 0)", () => {
    ...
    _test("execution of br_0: nested-br_table-value-index (instance 0)", () => {
        ...
        let _nested_br_table_value_index_result = module.invoke(_nested_br_table_value_index);
...
describe("br_1", () => {
    ...
    _test("execution of br_1: _inline_test_0 (instance 0)", () => {
...
describe("br_2", () => {
    ...
    _test("execution of br_2: _inline_test_1 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_3", () => {
    ...
    _test("execution of br_3: _inline_test_2 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_4", () => {
    ...
    _test("execution of br_4: _inline_test_3 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_5", () => {
    ...
    _test("execution of br_5: _inline_test_4 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_6", () => {
    ...
    _test("execution of br_6: _inline_test_5 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_7", () => {
    ...
    _test("execution of br_7: _inline_test_6 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_8", () => {
    ...
    _test("execution of br_8: _inline_test_7 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_9", () => {
    ...
    _test("execution of br_9: _inline_test_8 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_10", () => {
    ...
    _test("execution of br_10: _inline_test_9 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_11", () => {
    ...
    _test("execution of br_11: _inline_test_10 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_12", () => {
    ...
    _test("execution of br_12: _inline_test_11 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_13", () => {
    ...
    _test("execution of br_13: _inline_test_12 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_14", () => {
    ...
    _test("execution of br_14: _inline_test_13 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_15", () => {
    ...
    _test("execution of br_15: _inline_test_14 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_16", () => {
    ...
    _test("execution of br_16: _inline_test_15 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_17", () => {
    ...
    _test("execution of br_17: _inline_test_16 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_18", () => {
    ...
    _test("execution of br_18: _inline_test_17 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_19", () => {
    ...
    _test("execution of br_19: _inline_test_18 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
...
describe("br_20", () => {
    ...
    _test("execution of br_20: _inline_test_19 (instance 0)", () => {
        expect(() => None.toThrow(TypeError, "Execution trapped"));
    });
});
