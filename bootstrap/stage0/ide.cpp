...
__jakt_var_706 = Jakt::DeprecatedString("struct"sv); goto __jakt_label_629;
...
__jakt_var_707 = Jakt::DeprecatedString("class"sv); goto __jakt_label_630;
...
__jakt_var_709 = Jakt::DeprecatedString("enum"sv); goto __jakt_label_632;
...
__jakt_var_712 = static_cast<JaktInternal::Optional<DeprecatedString>>(result); goto __jakt_label_635;
...
__jakt_var_713 = static_cast<JaktInternal::Optional<DeprecatedString>>(output); goto __jakt_label_636;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<DeprecatedString>> __jakt_var_714; {
DeprecatedString const result = TRY((ide::get_enum_variant_signature(program,name,type_id,variants,number_constant)));
__jakt_var_714 = static_cast<JaktInternal::Optional<DeprecatedString>>(result); goto __jakt_label_637;
...
__jakt_var_715 = ((expr)->to_number_constant(program)); goto __jakt_label_638;

}
__jakt_label_638:; __jakt_var_715.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_716; {
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_716 = none; goto __jakt_label_639;
...
__jakt_var_717 = TRY((__jakt_format(Jakt::DeprecatedString("function({}) -> {}"sv),utility::join(param_names,Jakt::DeprecatedString(", "sv)),return_type))); goto __jakt_label_640;
...
return JaktInternal::ExplicitValue(Jakt::DeprecatedString(""sv));
 ...
 + Jakt::DeprecatedString("enum "sv)) + ((enum_).name)); goto __jakt_label_641;
...
__jakt_var_719 = (JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<DeprecatedString, ErrorOr<DeprecatedString>>{
...
)) + ((struct_).name)); goto __jakt_label_642;
...
__jakt_var_723 = (output + Jakt::DeprecatedString(">"sv)); goto __jakt_label_646;
...
__jakt_var_724 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_647;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename ide::Usage::Call>();
types::FunctionId const& function_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<DeprecatedString>> __jakt_var_725; {
types::TypeId const result_type_id = ((((program)->get_function(function_id)))->return_type_id);
__jakt_var_725 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_648;
...
__jakt_var_726 = TRY((__jakt_format(Jakt::DeprecatedString("{} {}: {}"sv),mut_string,name,type_name))); goto __jakt_label_649;
...
__jakt_var_727 = output; goto __jakt_label_650;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<DeprecatedString>,types::TypeId>>> __jakt_var_728; {
JaktInternal::Optional<DeprecatedString> const string_none = JaktInternal::OptionalNone();
__jakt_var_728 = (TRY((DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<DeprecatedString>,types::TypeId>>::create_with({(Tuple{string_none, type_id})})))); goto __jakt_label_651;
...
__jakt_var_729 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_652;
...
__jakt_var_730 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_653;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename ide::Usage::Typename>();
types::TypeId const& type_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_731; {
__jakt_var_731 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_654;
...
__jakt_var_732 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_655;
...
__jakt_var_737 = none; goto __jakt_label_660;
...
__jakt_var_738 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_661;
...
__jakt_var_744 = names; goto __jakt_label_667;

}
__jakt_label_667:; __jakt_var_744.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<DeprecatedString>> __jakt_var_745; {
__jakt_var_745 = (TRY((Set<DeprecatedString>::create_with_values({TRY((__jakt_format(Jakt::DeprecatedString("else ({})"sv),TRY((((program)->type_name(type_id)))))))})))); goto __jakt_label_668;
...
__jakt_var_742 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_AT_LOOP_NESTED_MATCH(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ide::Usage>,ErrorOr<JaktInternal::Optional<ide::Usage>>>{
...
__jakt_var_746 = static_cast<JaktInternal::Optional<ide::Usage>>( ide::Usage { typename ide::Usage::NameSet(cases_array) } ); goto __jakt_label_669;
...
__jakt_var_739 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_662;
...
__jakt_var_748 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_671;
...
__jakt_var_749 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ide::Usage>,ErrorOr<JaktInternal::Optional<ide::Usage>>>{
...
auto&& __jakt_match_value = __jakt_match_variant.template get<types::Type::GenericInstance>();types::StructId const& struct_id = __jakt_match_value.id;
JaktInternal::DynamicArray<types::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_751; {
...
__jakt_var_751 = output; goto __jakt_label_674;
...
__jakt_var_752 = none; goto __jakt_label_675;

}
__jakt_label_675:; __jakt_var_752.release_value(); }));
};/*case end*/
case 13: {
auto&& __jakt_match_value = __jakt_match_variant.template get<types::CheckedStatement::InlineCpp>();return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ide::Usage>> __jakt_var_753; {
JaktInternal::Optional<ide::Usage> const output = JaktInternal::OptionalNone();
__jakt_var_753 = output; goto __jakt_label_676;
...
__jakt_var_755 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_678;
...
__jakt_var_756 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_679;
