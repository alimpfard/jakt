...
ids::FunctionId const method_struct_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_struct(method_struct_id))).scope_id),TRY(DeprecatedString::from_utf8("Method"sv)),JaktInternal::OptionalNone())))).value());
ids::FunctionId const function_struct_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_struct(function_struct_id))).scope_id),TRY(DeprecatedString::from_utf8("Function"sv)),JaktInternal::OptionalNone())))).value());
...
NonnullRefPtr<types::CheckedFunction> const function = ((((*this).program))->get_function((((TRY((((((*this).program))->find_functions_with_name_in_scope(((((*this).program))->prelude_scope_id()),TRY(DeprecatedString::from_utf8("as_saturated"sv)),false,JaktInternal::OptionalNone())))).value()))[static_cast<i64>(0LL)])));
...
__jakt_var_227 = interpreter::StatementResult::JustValue(types::Value(TRY((types::ValueImpl::Struct((TRY((DynamicArray<types::Value>::create_with({types::Value(TRY((types::ValueImpl::JaktString(TRY(DeprecatedString::from_utf8(""sv))))),call_span)})))),string_builder_struct_id,JaktInternal::OptionalNone()))),call_span)); goto __jakt_label_213;
...
__jakt_var_287 = interpreter::StatementResult::JustValue(types::Value(TRY((types::ValueImpl::JaktString(DeprecatedString::repeated(character,count)))),call_span)); goto __jakt_label_273;
...
JaktInternal::Dictionary<DeprecatedString,JaktInternal::Tuple<ids::TypeId,JaktInternal::Optional<JaktInternal::Tuple<NonnullRefPtr<typename parser::ParsedExpression>,ids::ScopeId>>>> const params = (((mapper_value).impl))->as.Function.params;
...
JaktInternal::DynamicArray<ids::FunctionId> const range_constructors = (TRY((((((*this).program))->find_functions_with_name_in_scope(((((((*this).program))->get_struct(range_struct_id))).scope_id),TRY(DeprecatedString::from_utf8("Range"sv)),false,JaktInternal::OptionalNone())))).value());
...
JaktInternal::Dictionary<DeprecatedString,JaktInternal::Tuple<ids::TypeId,JaktInternal::Optional<JaktInternal::Tuple<NonnullRefPtr<typename parser::ParsedExpression>,ids::ScopeId>>>> resolved_params = (TRY((Dictionary<DeprecatedString, JaktInternal::Tuple<ids::TypeId,JaktInternal::Optional<JaktInternal::Tuple<NonnullRefPtr<typename parser::ParsedExpression>,ids::ScopeId>>>>::create_with_entries({}))));
...
ids::FunctionId const field_struct_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_struct(field_struct_id))).scope_id),TRY(DeprecatedString::from_utf8("Field"sv)),JaktInternal::OptionalNone())))).value());
...
ids::FunctionId const visibility_public_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(visibility_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("Public"sv)),JaktInternal::OptionalNone())))).value());
ids::FunctionId const visibility_private_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(visibility_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("Private"sv)),JaktInternal::OptionalNone())))).value());
...
ids::FunctionId const variable_declaration_struct_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_struct(variable_declaration_struct_id))).scope_id),TRY(DeprecatedString::from_utf8("VariableDeclaration"sv)),JaktInternal::OptionalNone())))).value());
...
ids::FunctionId const typed_variant_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(sum_enum_variant_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("Typed"sv)),JaktInternal::OptionalNone())))).value());
ids::FunctionId const struct_like_variant_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(sum_enum_variant_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("StructLike"sv)),JaktInternal::OptionalNone())))).value());
ids::FunctionId const untyped_variant_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(sum_enum_variant_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("Untyped"sv)),JaktInternal::OptionalNone())))).value());
ids::StructId const field_struct_id = ({
    auto&& _jakt_value = ([&]() -> JaktInternal::ExplicitValueOrControlFlow<ids::StructId, ErrorOr<JaktInternal::DynamicArray<types::Value>>>{
auto&& __jakt_match_variant = TRY((((((*this).program))->find_reflected_primitive(TRY(DeprecatedString::from_utf8("Field"sv))))));
switch(__jakt_match_variant.__jakt_init_index()) {
...
ids::FunctionId const constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_struct(struct_id))).scope_id),TRY(DeprecatedString::from_utf8("from_string_literal"sv)),JaktInternal::OptionalNone())))).value());
...
JaktInternal::Optional<ids::FunctionId> const constructor = TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(reflected_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("TypeVariable"sv)),JaktInternal::OptionalNone()))));
if ((!(((constructor).has_value())))){
TRY((((*this).error(TRY(DeprecatedString::from_utf8("Attempted to access a variant that does not exist"sv)),span))));
return Error::__jakt_from_string_literal((StringView::from_string_literal("Invalid type"sv)));
}
...
JaktInternal::Optional<ids::FunctionId> const constructor = TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(reflected_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("StructureOrEnum"sv)),JaktInternal::OptionalNone()))));
if ((!(((constructor).has_value())))){
TRY((((*this).error(TRY(DeprecatedString::from_utf8("Attempted to access a variant that does not exist"sv)),span))));
return Error::__jakt_from_string_literal((StringView::from_string_literal("Invalid type"sv)));
}
...
ids::FunctionId const record_struct_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_struct(record_struct_id))).scope_id),TRY(DeprecatedString::from_utf8("Record"sv)),JaktInternal::OptionalNone())))).value());
...
ids::FunctionId const record_type_struct_constructor = (TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(record_type_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("Struct"sv)),JaktInternal::OptionalNone())))).value());
...
if (__jakt_enum_value == true) {
return JaktInternal::ExplicitValue((TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(record_type_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("ValueEnum"sv)),JaktInternal::OptionalNone())))).value()));
}
else {
return JaktInternal::ExplicitValue((TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(record_type_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("SumEnum"sv)),JaktInternal::OptionalNone())))).value()));
}
}());
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
...
JaktInternal::Optional<ids::FunctionId> const constructor = TRY((((((*this).program))->find_function_in_scope(((((((*this).program))->get_enum(reflected_enum_id))).scope_id),TRY(DeprecatedString::from_utf8("Function"sv)),JaktInternal::OptionalNone()))));
if ((!(((constructor).has_value())))){
TRY((((*this).error(TRY(DeprecatedString::from_utf8("Attempted to access a variant that does not exist"sv)),span))));
return Error::__jakt_from_string_literal((StringView::from_string_literal("Invalid type"sv)));
}
