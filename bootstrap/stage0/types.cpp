...
return ((Tuple{(maybe_function.value()), scope_id}));
}
{
...
NonnullRefPtr<types::Scope> const scope = TRY((types::Scope::create(none_string,none_string,(TRY((Dictionary<DeprecatedString, types::VarId>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::Value>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::StructId>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, JaktInternal::DynamicArray<types::FunctionId>>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::EnumId>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::TypeId>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::TraitId>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::ModuleId>::create_with_entries({})))),(TRY((Dictionary<DeprecatedString, types::ScopeId>::create_with_entries({})))),parent_scope_id,JaktInternal::OptionalNone(),(TRY((DynamicArray<types::ScopeId>::create_with({})))),can_throw,JaktInternal::OptionalNone(),JaktInternal::OptionalNone(),(TRY((DynamicArray<parser::IncludeAction>::create_with({})))),(TRY((DynamicArray<parser::IncludeAction>::create_with({})))),debug_name)));
...
if (((scope_id).equals(check_scope_id))){
return (true);
}
NonnullRefPtr<types::Scope> const scope = TRY((((*this).get_scope(scope_id))));
{
...
JaktInternal::Tuple<DeprecatedString,types::ScopeId> ___alias__ = (_magic_value.value());
{
JaktInternal::Tuple<DeprecatedString,types::ScopeId> const jakt_____alias__ = ___alias__;
DeprecatedString const _ = ((jakt_____alias__).template get<0>());
types::ScopeId const alias = ((jakt_____alias__).template get<1>());

if (((alias).equals(check_scope_id))){
return (true);
}
}
...
return (((types::ScopeId(((scope_id).module_id),static_cast<size_t>(0ULL))).equals(check_scope_id)));
}
}
...
TRY((((seen).add(TRY((((scope_id).to_string())))))));
NonnullRefPtr<types::Scope> const scope = TRY((((*this).get_scope(scope_id))));
if ((((((scope)->namespace_name)).has_value()) && ((((scope)->namespace_name).value()) == name))){
return ((Tuple{scope_id, false}));
}
if (((((scope)->aliases)).contains(name))){
return ((Tuple{((((scope)->aliases))[name]), treat_aliases_as_imports}));
}
if (((((scope)->parent)).has_value())){
TRY((((scopes_to_check).insert(static_cast<size_t>(0ULL),(((scope)->parent).value())))));
{
