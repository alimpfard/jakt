...
TRY((((builder).append_string(Jakt::DeprecatedString(")"sv)))));
__jakt_var_684 = TRY((((builder).to_string()))); goto __jakt_label_622;
...
__jakt_var_685 = TRY((__jakt_format(Jakt::DeprecatedString("{}..{}"sv),from_output,to_output))); goto __jakt_label_623;
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_690; {
DeprecatedStringBuilder builder = TRY((DeprecatedStringBuilder::create()));
{
...
TRY((((builder).append_string(Jakt::DeprecatedString(")"sv)))));
__jakt_var_690 = TRY((((builder).to_string()))); goto __jakt_label_628;
...
repl::LineResult const line_result = ({ Optional<repl::LineResult> __jakt_var_692;
auto __jakt_var_693 = [&]() -> ErrorOr<repl::LineResult> { return TRY((((editor).get_line()))); }();
if (__jakt_var_693.is_error()) {auto error = __jakt_var_693.release_error();
{
return {};
}
...
JaktInternal::DynamicArray<lexer::Token> const tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_694;
auto __jakt_var_695 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return TRY((lexer::Lexer::lex(((*this).compiler)))); }();
if (__jakt_var_695.is_error()) {{
continue;
}
} else {__jakt_var_694 = __jakt_var_695.release_value();
}
__jakt_var_694.release_value(); });
if (((tokens).is_empty())){
continue;
}
...
parser::ParsedNamespace const parsed_namespace = ({ Optional<parser::ParsedNamespace> __jakt_var_696;
auto __jakt_var_697 = [&]() -> ErrorOr<parser::ParsedNamespace> { return TRY((((parser).parse_namespace()))); }();
if (__jakt_var_697.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_696 = __jakt_var_697.release_value();
}
__jakt_var_696.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
auto __jakt_var_699 = [&]() -> ErrorOr<void> { return TRY((((((*this).typechecker)).typecheck_module(parsed_namespace,((*this).root_scope_id))))), ErrorOr<void>{}; }();
...
NonnullRefPtr<typename parser::ParsedStatement> const parsed_statement = ({ Optional<NonnullRefPtr<typename parser::ParsedStatement>> __jakt_var_700;
auto __jakt_var_701 = [&]() -> ErrorOr<NonnullRefPtr<typename parser::ParsedStatement>> { return TRY((((parser).parse_statement(true)))); }();
if (__jakt_var_701.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_700 = __jakt_var_701.release_value();
}
__jakt_var_700.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
NonnullRefPtr<typename types::CheckedStatement> const checked_statement = ({ Optional<NonnullRefPtr<typename types::CheckedStatement>> __jakt_var_702;
auto __jakt_var_703 = [&]() -> ErrorOr<NonnullRefPtr<typename types::CheckedStatement>> { return TRY((((((*this).typechecker)).typecheck_statement(parsed_statement,((*this).root_scope_id), types::SafetyMode { typename types::SafetyMode::Safe() } ,JaktInternal::OptionalNone())))); }();
if (__jakt_var_703.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_702 = __jakt_var_703.release_value();
}
__jakt_var_702.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
...
interpreter::StatementResult const result = ({ Optional<interpreter::StatementResult> __jakt_var_704;
auto __jakt_var_705 = [&]() -> ErrorOr<interpreter::StatementResult> { return TRY((((interpreter)->execute_statement(checked_statement,((*this).root_interpreter_scope),utility::Span(((*this).file_id),static_cast<size_t>(0ULL),((line).length())))))); }();
if (__jakt_var_705.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_704 = __jakt_var_705.release_value();
}
__jakt_var_704.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
