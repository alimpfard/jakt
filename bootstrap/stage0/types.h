...
JaktInternal::Dictionary<DeprecatedString,JaktInternal::Tuple<ids::TypeId,JaktInternal::Optional<JaktInternal::Tuple<NonnullRefPtr<typename parser::ParsedExpression>,ids::ScopeId>>>> params;
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> ByteConstant(JaktInternal::Optional<JaktInternal::Dictionary<ids::TypeId,ids::TypeId>> generic_inferences, DeprecatedString val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> CharacterConstant(JaktInternal::Optional<JaktInternal::Dictionary<ids::TypeId,ids::TypeId>> generic_inferences, DeprecatedString val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> CCharacterConstant(JaktInternal::Optional<JaktInternal::Dictionary<ids::TypeId,ids::TypeId>> generic_inferences, DeprecatedString val, utility::Span span);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> IndexedCommonEnumMember(JaktInternal::Optional<JaktInternal::Dictionary<ids::TypeId,ids::TypeId>> generic_inferences, NonnullRefPtr<typename types::CheckedExpression> expr, DeprecatedString index, utility::Span span, bool is_optional, ids::TypeId type_id);
...
public: ErrorOr<JaktInternal::Optional<ids::FunctionId>> find_default_constructors_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
public: ErrorOr<JaktInternal::Optional<ids::StructId>> find_struct_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
public: ErrorOr<JaktInternal::Optional<ids::TypeId>> find_type_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
private: ErrorOr<JaktInternal::Optional<bool>> for_each_scope_accessible_unqualified_from_scope_impl(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<bool>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
public: protected:
explicit CheckedProgram(NonnullRefPtr<compiler::Compiler> a_compiler, JaktInternal::DynamicArray<NonnullRefPtr<types::Module>> a_modules, JaktInternal::Dictionary<DeprecatedString,types::LoadedModule> a_loaded_modules, JaktInternal::Optional<ids::ScopeId> a_root_scope_id);
public:
static ErrorOr<NonnullRefPtr<CheckedProgram>> __jakt_create(NonnullRefPtr<compiler::Compiler> compiler, JaktInternal::DynamicArray<NonnullRefPtr<types::Module>> modules, JaktInternal::Dictionary<DeprecatedString,types::LoadedModule> loaded_modules, JaktInternal::Optional<ids::ScopeId> root_scope_id);
...
public: ErrorOr<JaktInternal::Optional<JaktInternal::Tuple<ids::TypeId,ids::ScopeId>>> find_type_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
public: ErrorOr<ids::StructId> builtin_implementation_struct(types::BuiltinType const builtin, ids::ModuleId const for_module);
public: ErrorOr<JaktInternal::Optional<types::Value>> find_comptime_binding_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
private: ErrorOr<JaktInternal::Optional<bool>> for_each_scope_accessible_unqualified_from_scope_direct_chain(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<bool>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
public: ErrorOr<JaktInternal::Optional<JaktInternal::Tuple<ids::ScopeId,bool>>> find_namespace_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const treat_aliases_as_imports, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
public: ErrorOr<JaktInternal::Optional<ids::TraitId>> find_trait_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
public: ErrorOr<ids::TypeId> apply_qualifiers_to_type(parser::CheckedQualifiers const qualifiers, ids::TypeId const type_id);
public: ErrorOr<JaktInternal::Optional<JaktInternal::DynamicArray<ids::FunctionId>>> find_functions_with_name_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
public: ErrorOr<JaktInternal::Optional<NonnullRefPtr<types::CheckedVariable>>> find_var_in_scope(ids::ScopeId const scope_id, DeprecatedString const var, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
public: ErrorOr<JaktInternal::Optional<ids::FunctionId>> find_function_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
public: ErrorOr<JaktInternal::Optional<ids::EnumId>> find_enum_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
...
ErrorOr<JaktInternal::Optional<T>> for_each_scope_accessible_unqualified_from_scope(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<T>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback, bool const ignore_mixin_scopes, JaktInternal::Optional<ids::ScopeId> const root_scope) const;
